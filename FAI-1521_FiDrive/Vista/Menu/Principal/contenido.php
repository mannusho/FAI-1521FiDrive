    ...
    <div class="card text-center">
            ...
            <div class="form-group row">
                    <div class="col-md-6 mb-3">
                        <form action="accion.php" method="POST" id="newF" name="newF">
                            <label for="newFolder">Genere una nueva carpeta: </label><br>
                            <input type="text" name="foldername" id="foldername" placeholder="Nombre de la carpeta" required>
                            <button type="submit" class="btn btn-dark"> Nueva carpeta <i class="fa fa-folder-o" style="color:white;"></i></button>
                            <small  class="form-text text-muted"> Esto generara una carpeta dentro de la carpeta que actualmente este seleccionada. </small>
                        </form>
                    </div>
                    <div class="col-md-6 mb-3">
